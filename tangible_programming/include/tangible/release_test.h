#ifndef TANGIBLE_RELEASE_TEST
#define TANGIBLE_RELEASE_TEST
...
#include "tangible_msgs/ReleaseTest.h"
...
public:
	ReleaseTest(ros::NodeHandle& n, std::string scene_service_name, std::string grasp_service_name);
	~ReleaseTest();

	bool testCallback(tangible_msgs::ReleaseTest::Request& req,
